...
if (isset($_POST['login'])) {
    ...
    if ($email && $pass) {
        ...
        if ($response == 1) {
            ...
            $stringToFile = get_client_ip() . "," . $_SESSION['email'] . "," . $_SESSION['username'] . "," . date('m/d/Y h:i:s a', time()) . "\n";
    ...
    <div class="row">
        <div class="offset-md-3 col-md-6">
            ...
            if (count($errors) > 0) {
                ...
                $errs .= "]";
                $error_string = get_client_ip() . "," . $errs . "," . date('m/d/Y h:i:s a', time()) . "\n";
                writeToFile("error_logs.txt", $error_string);
            }
            ?>
